//! Implements the secret autopilot planner that routes Pac-Man through the maze while avoiding ghost threats.
...
impl<'a> Planner<'a> {
    ...
    /// Resolves simulated ghost collision.
...
mod tests {
    ...
    #[test]
    /// Computes reverses before running into a dead end.
